...
*/    var getOwnPropertySymbols = Object.getOwnPropertySymbols;
    ...
    window.addEventListener("DOMContentLoaded", (function() {
        ...
        setTimeout((function() {
            ...
            let navPath = document.querySelector(".nav-change-path");
            CSSRulePlugin.getRule(".humburger span:before");
            gsap.set(".hide-nav", {
                visibility: "hidden"
            });
            function revealMenu() {
        ...
        if (window.matchMedia("(min-width: 320px)").matches) gsap.to("#primeCase", {
            scrollTrigger: {
                trigger: ".prime",
                start: "top top",
                end: "bottom top",
